package com.example.ecoapp.screens
...
import com.example.ecoapp.data.Datasource
...
fun Post(post: Post, onClick: () -> Unit) {
    Card(modifier = Modifier.clickable { onClick() }) {
        Column(
            ...
            val postText = post.text.subSequence(0, 100).toString() + "..."
            ...
            Row(
                ...
                Row(
                    ...
                    Image(painterResource(id = R.drawable.thumb_up), contentDescription = "upVote")
